...
function StdntHistory() {
  ...
  const columns = [
    ...
    { key: 'unit_num', label: 'Unit Number' }
  ...
  const fetchStudentLog = () => {
    axios
    .get(`http://localhost:5000/sortstudentlog?column=${sortColumn}&order=${sortOrder}`, { withCredentials: true })
...
export default ProtectedRoute(StdntHistory);
